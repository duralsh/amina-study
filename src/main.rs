...
async fn main() -> Result<()> {
    ...
    let contract = create_contract_context(&config, "0xdcB6669062b47f6cC3DB7A70EAa8FcA3d1D16DfC").await?;
...
async fn create_contract_context(config: &Config, contract_address:&str) -> Result<ERC20Contract<SignerMiddleware<Provider<Http>, LocalWallet>>> {
